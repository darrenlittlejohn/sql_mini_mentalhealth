...
CREATE TABLE nsduh_2022 (
  mhttrtpy SMALLINT,         -- received mental health treatment past year (0/1)
...
ALTER TABLE nsduh_2022 RENAME COLUMN mhttrtpy TO received_treatment;
ALTER TABLE nsduh_2022 RENAME COLUMN mhtshldtx TO thought_should_get_treatment;
ALTER TABLE nsduh_2022 RENAME COLUMN mhtskthpy TO unmet_need_derived;
...
ALTER TABLE nsduh_2022 ADD COLUMN unmet_need SMALLINT;
...
SELECT COUNT(*) FROM nsduh_2022;
SELECT * FROM nsduh_2022 LIMIT 20;
